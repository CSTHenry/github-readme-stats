...
async function run() {
  try {
    ...
    const url = `https://github-readme-stats.csthenry.vercel.app/api?username=CSTHenry&title_color=${titleColor}&icon_color=${iconColor}&text_color=${textColor}&bg_color=${bgColor}&show_icons=true`;
